...
#time_value = datetime.strptime(csv_line[0] + '000', '%m/%d/%Y%H%M%S')
...
#df3['net_time'] = pd.to_timedelta('net_time')
#df3['official_time'] = pd.to_timedelta('official_time')
#pd.Timedelta(np.timedelta64(1, "ms"))
#df3['official_time'] = pd.to_datetime(df3['official_time'])
